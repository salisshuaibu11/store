      ...
      <div>
        ...
        <div className="shadow-lg py-4 bg-white rounded-md flex flex-col">
          <div className="px-4">
            ...
            <button className="py-2 px-5 rounded-md">
              Paypal
            </button>
          </div>
          ...
          <form className="px-4 mt-3 md:w-2/5 w-full">
            ...
            <div class="w-full mb-5">
                <label htmlFor="card-number" className="font-extralight text-gray-500">Zip Code</label>
                <input
                  type="text"
                  id="card-number"
                  className="w-full px-4 py-1 text-gray-600 border-2 border-gray-400 rounded-lg outline-none md:px-8 focus:shadow-xl"/>
          ...
          <button className="bg-blue-600 self-center py-2 px-4 rounded-lg outline-none text-white">
            Save Changes
          </button>
        </div>
      </div>
